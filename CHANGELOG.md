...
- Add `securitypolicyviolation` event listener to listen for CSP violations. If customers have set up CSP violation policy for their app, the event listern will detect violations and print warnings.
